...
public class Test_Relational_Postgres_EssentialFunctions_PCT extends PCTReportConfiguration
{
    ...
    private static final MutableList<ExclusionSpecification> expectedFailures = Lists.mutable.with(
            ...
            one("meta::pure::functions::date::tests::testAdjustByNanoseconds_Function_1__Boolean_1_", "org.postgresql.util.PSQLException: ERROR: invalid input syntax for type interval"),
            one("meta::pure::functions::date::tests::testAdjustByNanosecondsBigNumber_Function_1__Boolean_1_", "org.postgresql.util.PSQLException: ERROR: invalid input syntax for type interval"),
            ...
            one("meta::pure::functions::date::tests::testDateDiffWeeks_Function_1__Boolean_1_", "ERROR: function date_part(unknown, integer) does not exist"),
            ...
            one("meta::pure::functions::date::tests::testDateDiffDays_Function_1__Boolean_1_", "ERROR: function date_part(unknown, integer) does not exist"),
